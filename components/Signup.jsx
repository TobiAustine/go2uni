           ...
           <div className={styles.FormInput_text}>
             ...
             <form onSubmit={onSubmit}>
              ...
              <dl>
                ...
                <dd> <input name="name" className={styles.forms_box} value={form.name} onChange={onChange}></input> </dd>

                <dt className={styles.form_text}> Email Address </dt>
                <dd width="100%"> <input name="email" type="email" className={styles.forms_box} value={form.email} onChange={onChange}></input> </dd>

                <dt className={styles.form_text}>Password</dt>
                <dd> <input name="password" type="password" className={styles.forms_box} value={form.password} onChange={onChange}></input> </dd>
